...
import {useUpdateRawData} from "../../../utils/exportFile/UpdateExcel";
...
export default defineComponent({
  ...
  setup() {
    ...
    const toPreviewExcelData = async (rawFile) => {
      const { excelData, header } = await useUpdateRawData(rawFile)
      state.excelData = excelData
      state.header = header
      state.loading = false
    }
    const handleFileData = (rawFile) => {
