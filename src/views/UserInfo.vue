  ...
  <div class="page-container">
    <div class="info">
      ...
      >个人中心通常用来作为个人基本信息展示和个人事务通知中心
        ...
        >fullCalendar Demo <el-tooltip class="item" effect="dark" :content="contentTip" placement="top-start"> <i
            class="el-icon-question"></i></el-tooltip> </el-link
        ></span>
    </div>
    <el-row :gutter="20">
      <el-col :span="7" :offset="1">
        <el-card class="box-card">
          <div class="account-avatar">
            ...
            <div class="account-name">飞翔的小白</div>
            <div class="account-sign">只有守得住寂寞，方能享的了长远！</div>
          </div>
