 ...
 * @param title
 */
export const useInitPlot = (plot, title) => {
 ...
 * @param barContainer
 */
export const useInitBar = (barContainer) => {
    const data = [
 ...
 * @param charContainer
 */
export const useInitChart = (charContainer) => {
    const data = [
 ...
 */
export const useInitIndicator = (indicatorContainer) => {
...
export const useInitAge = (ageContainer) => {
